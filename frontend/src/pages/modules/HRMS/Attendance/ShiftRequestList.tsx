...
const ShiftRequestList = () => {
    ...
    const { data: requests, isLoading, error } = useFrappeGetDocList('Shift Request', {
    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold tracking-tight">Shift Requests</h1>
                <Link to="/hrms/shift-requests/new">
                    <Button>
                        ...
                        <TableBody>
                            {requests?.map((req: any) => (
                                <TableRow key={req.name}>
                                    <TableCell className="font-medium">{req.shift_type}</TableCell>
                                    <TableCell>
