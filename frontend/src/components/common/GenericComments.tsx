...
const GenericComments: React.FC<GenericCommentsProps> = ({ doctype, docname }) => {
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex items-center justify-between">
                                    <span className="text-xs text-muted-foreground">
                                        Type <kbd className="px-1 py-0.5 text-xs border rounded bg-slate-50">@</kbd> to mention • Press{" "}
                                        <kbd className="px-1 py-0.5 text-xs border rounded bg-slate-50">Ctrl+Enter</kbd> to submit
                                    </span>
                                    <Button
                                        onClick={handleAddComment}
                                        disabled={isSubmitting}
                                        size="sm"
                                        className="bg-gradient-to-r from-blue-600 to-blue-400 text-white border-none shadow-md hover:shadow-lg hover:opacity-90 transition-all duration-200 active:scale-95"
                                    >
                ...
                {comments && comments.length > 0 ? (
                    <div className="space-y-4">
                        {comments.map((comment) => (
                            <Card key={comment.name} className="border-l-4 border-l-primary/20 shadow-sm">
